...
OPTIONAL_ENV_VARS = {
    ...
    "GOOGLE_OAUTH_CLIENT_ID": {
        "description": "Google OAuth client ID for per-user Google Calendar access",
    ...
    "GOOGLE_OAUTH_CLIENT_SECRET": {
        "description": "Google OAuth client secret for per-user Google Calendar access",
    ...
    "GOOGLE_OAUTH_REDIRECT_URI": {
        "description": "Exact Google OAuth redirect URI for Calendar callback",
    ...
    "GOOGLE_OAUTH_PUBLIC_URL": {
        "description": "Public service origin used to derive the Google Calendar OAuth callback URL",
        "prompt": "Google OAuth public URL",
        "url": None,
        "tools": ["calendar"],
        "password": False,
        "category": "tool",
